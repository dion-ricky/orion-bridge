...
if ($query != "") { $last = $query; } elseif (isset($_GET['last'])) { $last = $_GET['last']; }
  ...
  <table width="400" cellspacing="1" cellpadding="3">
    <tr>
      <td>
		...
		<label for="query">
		  <input name="pk" type="hidden" id="pk" value="<?php echo $pk; ?>">
	    Search:</label>
...
<table width="889" cellpadding="3" cellspacing="1" class="searchTrigger">
  <tr>
    ...
    <th width="133" nowrap="nowrap" scope="col">Kode</th>
    <th width="144" nowrap="nowrap" scope="col">Barcode</th>
    <th width="272" nowrap="nowrap" scope="col">Nama Barang</th>
...
?>
  <tr>
    ...
    <td nowrap="nowrap"><a href="" result="<?php echo $results['barcode']; ?>" pk="<?php echo $_GET['pk']; ?>" onClick="return windowClose(this);" >Insert</a></td>
  </tr>
  <?php 
		} // While
	} // If num_rows>0
