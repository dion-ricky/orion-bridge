...
$maxDate = date('Y-m-d');
?>
<h1>SALES DATA REPORT PER PERIOD</h1>
...
<br>
<?php
	$mySql = "SELECT penjualan.*, pelanggan.nm_pelanggan, user.nm_user FROM penjualan JOIN pelanggan ON penjualan.kd_pelanggan=pelanggan.kd_pelanggan JOIN user ON penjualan.kd_user=user.kd_user WHERE penjualan.tgl_penjualan BETWEEN '$dateFrom' AND '$dateUntil' ORDER BY penjualan.no_penjualan";
...
<table width="800" cellspacing="1" cellpadding="3" class="table-list">
  <tr>
    ...
    <th width="179" nowrap="nowrap" scope="col">Customer</th>
...
?>
  <tr>
    ...
    <td align="center"><a href="cetak/penjualan_cetak.php?noNota=<?php echo $myData['no_penjualan']; ?>&noprint" target="_blank">Print</a></td>
  </tr>
<?php
}
?>
